...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference("Datum.count") do
      post data_url, params: { datum: { ad: @datum.ad, marka: @datum.marka, yorum: @datum.yorum } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { ad: @datum.ad, marka: @datum.marka, yorum: @datum.yorum } }
